...
void get_key_info(uint16_t key_value)
{
    ...
    switch (current) {
        case 0x2000:
            cmd_str = "关机";
            DisplayString_chat(0, 0, WHITE, "LED: ON ");
            break;
        case 0x200:
            cmd_str = "主菜单";
            DisplayString_chat(0, 0, WHITE, "LED: OFF");
            break;
        case 0x1000:
            cmd_str = "前";
        ...
        case 0x800:
            cmd_str = "OK";
            DisplayString_chat(0, 26, WHITE, "GRB_Green: OFF");
            DisplayString_chat(130, 26, WHITE, "GRB_Red: OFF");
        ...
        case 0x10:
            cmd_str = "设置";
            DisplayString_chat(0, 90, WHITE, "Buzzer: ON ");
            break;
        case 0x20:
            cmd_str = "返回";
            DisplayString_chat(0, 90, WHITE, "Buzzer: OFF");
            break;
        case 0x40:
            cmd_str = "功能";
            break;
